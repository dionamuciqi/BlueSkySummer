<?php
    ...
    if(isset($_POST['submit'])){
        ...
        //update email
        if(!empty($email)){
            $select_email = $conn->prepare("SELECT `sellers` WHERE id = ? AND email = ?");
        ...
        if (!empty($image)){
            if($image_size >200000000){
                $warning_msg[] = 'Image size i s too large';
            }
            else{
        ...
        //update password
        $emtpy_pass  = '8cb2237d0679ca88db6464eac60da96345513964';
               ...
               <div class="col">
                  <div class="input-field">
                   ...
                   <div class="input-field">
                    ...
                    <input type="email" name="name" placeholder="<?= $fetch_profile['email']; ?> " class="box">
                </div>
                <div class="input-field">
